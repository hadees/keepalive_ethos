...
Gem::Specification.new do |spec|
  spec.name          = 'keepalive_ethos'
  spec.version       = KeepaliveEthos::VERSION
  spec.authors       = ['Evan Alter']
  spec.email         = ['evan.alter@gmail.com']

  spec.summary       = 'For keeping Ethos servers online'
  spec.description   = 'For keeping Ethos servers online'
  spec.license       = 'MIT'
